...
const LINKS = [
  {
    title: "Product",
    items: ["UI Design", "Website Development"],
  },
  {
    title: "Service",
    items: ["Website Creation", "Website Development", "UI Design"],
  },
  {
    title: "Resource",
...
const FooterComponents = () => {
  return (
    <footer className="relative w-full backdrop-blur-md bg-white/10 mt-36 font-poppins">
      <div className="mx-auto w-full max-w-7xl px-8 ">
        ...
        <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-blue-gray-200 py-4 md:flex-row md:justify-between">
          <Typography
            variant="small"
            className="mb-4 text-center  text-customBlue font-medium font-poppins md:mb-0"
          >
            &copy; {currentYear} <a href="https://material-tailwind.com/">Pujashindu__</a>. All
            Rights Reserved.
          </Typography>
